    ...
    return (
        <div className='flex flex-col gap-6    h-full w-full text-black'>
            <div className='flex justify-between items-center w-full h-[2.25rem]'>
                ...
                <div className='w-[8.5625rem] p-[0.6rem] bg-[#FFF]  flex items-center justify-between flex-shrink-0 rounded-[0.25rem] border-[#D9D9D9] border-[1px] border-solid h-8  ' >
            ...
            <div className='flex justify-between self-stretch gap-6 w-full items-center bg-[#FFF]  '>
